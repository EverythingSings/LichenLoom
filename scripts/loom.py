...
def build():
    ...
    index_body = [
        "<h1>LichenLoom</h1>",
        "<p style='text-align:center;font-size:0.85rem;color:#666;'>Drag nodes • Pan canvas • Ctrl+Click to sporulate • Press 'S' for bloom</p>",
